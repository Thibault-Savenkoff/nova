...
global.Worker = class {
  constructor(f) {
    const code = `const {parentPort}=require('worker_threads');global.self=global;global.importScripts=f=>{Object.assign(global,{NovaDecode:require(${JSON.stringify(web)}+'/'+f)})};
